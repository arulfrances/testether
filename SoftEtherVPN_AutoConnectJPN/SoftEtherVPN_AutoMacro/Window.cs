...
namespace SoftEtherVPN_AutoMacro
{
        ...
        public class Window
        {
            ...
            public string Caption
            {
                get
                {
                    ...
                    while (true)
                    {
                        ...
                        int result = User32.GetWindowText(window_handle, sb, sb.Capacity);
            ...
            public int ControlID
            {
                get
                {
                    return User32.GetDlgCtrlID(window_handle);
                }
            }
            ...
            public bool Visible
            {
                ...
                /*
                    ...
                    */
                    ...
                    bool visible = User32.IsWindowVisible(window_handle);
        ...
        public int SendMessage(Interop.Messages Msg, IntPtr wParam, IntPtr lParam)
        {
            return Interop.SendMessage(Handle, (uint)Msg, wParam, lParam);
        }

        public int PostMessage(Interop.Messages Msg, IntPtr wParam, IntPtr lParam)
        {
            return Interop.PostMessage(Handle, (uint)Msg, wParam, lParam);
        }
        ...
        public void AttachToCorner(ScreenCorner corner)
            ...
            static public List<Window> GetAllChildWindows(IntPtr hwnd)
            {
                List<Window> childHandles = new List<Window>();
                ...
                try
                {
                    Interop.EnumWindowProc childProc = new Interop.EnumWindowProc(GetAllChildWindowsEnumWindow);
                    Interop.EnumChildWindows(hwnd, childProc, pointerChildHandlesList);
                }
                finally
                {
            ...
            static private bool GetAllChildWindowsEnumWindow(IntPtr hWnd, IntPtr lParam)
            {
                ...
                List<Window> childHandles = gcChildhandlesList.Target as List<Window>;
                childHandles.Add(new Window(hWnd));
